defmodule Magnetissimo.Crawlers.TorrentDownload do
  use GenServer
  import SweetXml
  require Logger
  alias Magnetissimo.{Torrent, Crawler, Parser}

  @site_name "TorrentDownload.info"
  @site_display_name "TorrentDownload"
  @site_url "https://www.torrentdownload.info/feed_latest"
  @period 15 * 60 * 1000
